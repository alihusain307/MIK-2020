...
<div class="welcome-header clearfix">
    ...
    <div class="welcome-promo-banner">
        <a class="welcome-promo-offer" href="<?php echo esc_url('https://hashthemes.com/wordpress-theme/total-plus/?utm_source=wordpress&utm_medium=total-welcome&utm_campaign=total-upgrade'); ?>" target="_blank"><?php echo esc_html__('Christmas & New Year Discount', 'total'); ?><span><?php echo esc_html__('40% OFF', 'square'); ?></span></a>
