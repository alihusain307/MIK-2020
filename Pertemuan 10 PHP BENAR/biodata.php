...
if (isset($_POST['btnserach'])) {
  ...
  $sql = $koneksi->query("SELECT * FROM biodata WHERE nama LIKE '%'. $search .'%' ORDER BY id DESC LIMIT $awalData, $jumlahDataPerHalaman");
                  ...
                  <tbody>
                    ...
                    <?php foreach ($sql as $row): ?>
                      <tr>
                        ...
                        <td><?= $row['nama']; ?></td>
                        <td class="center-align"><?= $row['tgl_lahir']; ?>.00</td>
